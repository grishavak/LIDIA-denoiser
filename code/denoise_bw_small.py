...
def denoise_bw_small_func():
    ...
    state_file_name0 = 'models/model_state_small_sigma_{}_bw.pt'.format(opt.sigma)
    ...
    print('Denoising a grayscale image with a small network and sigma = {} done, output PSNR = {:.2f}'.format(opt.sigma, psnr_dn))
    sys.stdout.flush()
