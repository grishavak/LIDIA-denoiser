...
def parse_input():
    ...
    # path
    parser.add_argument('--in_path', type=str, default='images/BSD68/color/')
...
def denoise_set_bw_func():
    ...
    for im_name in image_names:
        ...
        print('Denoising color {} with sigma = {} done, output PSNR = {:.2f}'.format(im_name, opt.sigma, psnr_dn))
        sys.stdout.flush()
    ...
    print('\nDenoising a color set with sigma = {} done, average PSNR = {:.2f}'.format(opt.sigma, avg_psnr))
    sys.stdout.flush()
