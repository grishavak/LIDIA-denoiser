...
def denoise_set_bw_small_func():
    ...
    for im_name in image_names:
        ...
        print('Denoising grayscale {} with a small network and sigma = {} done, output PSNR = {:.2f}'.format(im_name, opt.sigma, psnr_dn))
        sys.stdout.flush()
    ...
    print('\nDenoising a grayscale set with a small network and sigma = {} done, average PSNR = {:.2f}'.format(opt.sigma, avg_psnr))
    sys.stdout.flush()
