...
def blind_denoise_set_bw_func():
    ...
    state_file_name0 = 'models/model_state_sigma_blind_bw.pt'.format(opt.sigma)
    ...
    for im_name in image_names:
        ...
        print('Blind denoising of grayscale {} with sigma = {} done, output PSNR = {:.2f}'.format(im_name, opt.sigma, psnr_dn))
        sys.stdout.flush()
    ...
    print('\nBlind denoising a grayscale set with sigma = {} done, average PSNR = {:.2f}'.format(opt.sigma, avg_psnr))
    sys.stdout.flush()
